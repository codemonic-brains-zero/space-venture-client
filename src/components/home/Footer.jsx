...
const Footer = () => {
    return (
        <>
            {/* Footer starts */}
            <footer className="bg-[#3a1725] text-white py-4">
                <div className="container mx-auto text-center">
                    ...
                    <div className="bg-pink-200 px-3 py-4 flex justify-center items-center">
                        <p className="text-xl text-pink-700">© RoomQuest™ 2024</p>
